...
def pose_cls_video(video, save=False):
    # Load a model
...
#===========================================================================================================#  
    ...
    if save:
        ...
        out = cv2.VideoWriter('____output/'+video_name+'_pose_cls(70v3).mp4', cv2.VideoWriter_fourcc(*'mp4v'), 15, (frame_width, frame_height))
...
# pose_cls_video('datatest/12 - Trim.mp4', save=False)
